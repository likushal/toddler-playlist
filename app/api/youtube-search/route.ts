...
export async function GET(req: NextRequest) {
  ...
  const url = `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${encodeURIComponent(q)}&type=video&videoEmbeddable=true&videoSyndicated=true&maxResults=5&key=${apiKey}`;
